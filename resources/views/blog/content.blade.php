                ...
                <div id="post-data-cr" class="carousel slide carousel-fade" data-ride="carousel" data-interval="false">
                    <div class="carousel-inner">
                        <div class="item  active">
                            <img src="{{ asset('storage/'.$post->content) }}" alt="Gif image" class="img-res">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="sidebar__inner">
                    <div class="header">
                        <div class="avatar">
                            <img src="{{ asset('storage/'.$post->user->avatar) }}" alt="Avatar"
                                 class="img-circle img-res">
                        </div>
                        <div class="uname">
                            <div class="fluid">
                                <a href="{{route('user.profile', $post->user->id)}}">{{ $post->user->name }}<span>
                                    </span>
                                        <span class="time-ago">{{ $post->updated_at->diffForHumans() }}</span>
                                </a>

                                {{-- nut like --}}
                                <strong class="pointer pull-right">
                    ...
                    <div class="comments">
                        <ul class="post-comments-list">
                            <span class="main_post_comm">{{ $comments->count() }} Comments</span>
                            @foreach($comments as $item)
                                <li>
                                    <div class="dropdown pull-right">
                                        <ul class="dropdown-menu">
                                            <div class="pp_com_body"><a
                                                    href="{{ route('comment.destroy', $item->id) }}">Delete</a></div>
                                        </ul>
                                    </div>
                    ...
                    <div class="comment-box">
                        <form class="form" action="{{ route('comment.store', $post->id) }}" method="POST">
                            @csrf
                            <div class="text-input">
                                <div class="user-avatar post_avatar_">
                                    <img class="img-circle" src="https://vozer.vn/images/smileys/35.png" alt="avatar"/>
                                </div>
                                <div class="post_input_">
                                    <textarea name="content_comment" class="form-control" id="textareaId" cols="30"
