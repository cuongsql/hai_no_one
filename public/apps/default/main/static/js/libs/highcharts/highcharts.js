...
(function(S, K) {
    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            ...
            update: function() {
                ...
                if (this[f + "Setter"]) this[f + "Setter"]();
                    ...
                    a.attr
                        ? a.element && a.attr(f, e, null, !0)
                        : (a.style[f] = e + this.unit);
                u && u.call(a, e, this);
            },
            run: function(n, f, e) {
                var u = this,
                ...
                n !== f || this.elem["forceAnimate:" + this.prop]
                    ? ((this.startTime = +new Date()),
                      ...
                      (t.elem = this.elem),
                      (t.prop = this.prop),
                      t() && 1 === a.timers.push(t) && w(y))
                    : (delete x.curAnim[this.prop],
                      x.complete &&
                          0 === a.keys(x.curAnim).length &&
                          x.complete.call(this.elem));
            },
            step: function(n) {
                var f = +new Date(),
                    e,
                ...
                x.attr && !x.element
                    ...
                    ? ((this.now = this.end),
                      ...
                      e && t && t.call(x),
                      (n = !1))
                    : ((this.pos = u.easing((f - this.startTime) / w)),
                      (this.now =
            ...
            initPath: function(n, f, e) {
                ...
                function t(a, d) {
                    for (var c = (k - a.length) / p; 0 < c && c--; )
                        (q = a.slice().splice(a.length / v - p, p * v)),
                            (q[0] = d[k - p - c * p]),
                            h && ((q[p - 6] = q[p - 2]), (q[p - 5] = q[p - 1])),
                            [].splice.apply(a, [a.length / v, 0].concat(q)),
                            b && c--;
                }
                f = f || "";
                var w,
            ...
            var n,
                ...
                x = function(e, n) {
                    ...
                    a.objectEach(n, function(y, c) {
                        !a.isObject(y, !0) || a.isClass(y) || a.isDOMElement(y)
                            ? (e[c] = n[c])
                            : (e[c] = x(e[c] || {}, y));
                    });
                    return e;
        ...
        a.pad = function(a, f, e) {
            return (
                Array((f || 2) + 1 - String(a).replace("-", "").length).join(
                    e || 0
                ) + a
            );
        };
        ...
        a.datePropsToTimestamps = function(n) {
            a.objectEach(n, function(f, e) {
                a.isObject(f) && "function" === typeof f.getTime
                    ? (n[e] = f.getTime())
                    : (a.isObject(f) || a.isArray(f)) &&
                      a.datePropsToTimestamps(f);
            });
        };
                ...
                ? ((e = (e = n.match(u)) ? e[1] : -1),
                  null !== f &&
                      (f = a.numberFormat(
                          ...
                          e,
                          x.decimalPoint,
                          -1 < n.indexOf(",") ? x.thousandsSep : ""
                      )))
                : (f = (e || a.time).dateFormat(n, f));
            return f;
        };
        ...
        a.numberFormat = function(n, f, e, u) {
            ...
            -1 === f
                ...
                ? f &&
                  ...
                  ((w = f + +c[1]),
                  0 <= w
                      ? ((c[0] = (+c[0]).toExponential(w).split("e")[0]),
                        (f = w))
                      : ((c[0] = c[0].split(".")[0] || 0),
                        (n =
                            20 > f
                                ? (c[0] * Math.pow(10, c[1])).toFixed(f)
                                : 0),
                        (c[1] = 0)))
                : (f = 2);
            y = (
                Math.abs(c[1] ? c[0] : n) + Math.pow(10, -Math.max(f, t) - 1)
            ).toFixed(f);
            t = String(a.pInt(y));
        ...
        a.getStyle = function(n, f, e) {
            ...
            if ((n = I.getComputedStyle(n, void 0)))
                (n = n.getPropertyValue(f)),
                    a.pick(e, "opacity" !== f) && (n = a.pInt(n));
            return n;
        };
        ...
        a.map = function(a, f) {
            for (var e = [], u = 0, x = a.length; u < x; u++)
                e[u] = f.call(a[u], a[u], u, a);
            return e;
        };
        a.keys = function(n) {
        ...
        a.reduce = function(n, f, e) {
            return (a.reducePolyfill || Array.prototype.reduce).apply(
                n,
                2 < arguments.length ? [f, e] : [f]
            );
        };
        a.offset = function(a) {
            ...
            return {
                top:
                    a.top + (I.pageYOffset || f.scrollTop) - (f.clientTop || 0),
                left:
                    a.left +
                    (I.pageXOffset || f.scrollLeft) -
                    (f.clientLeft || 0)
            };
        };
        a.stop = function(n, f) {
        ...
        a.objectEach = function(a, f, e) {
            for (var u in a)
                a.hasOwnProperty(u) && f.call(e || a[u], a[u], u, a);
        };
        a.addEvent = function(n, f, e, u) {
            ...
            x =
                "function" === typeof n && n.prototype
                    ? (n.prototype.protoEvents = n.prototype.protoEvents || {})
                    : (n.hcEvents = n.hcEvents || {});
            a.Point &&
                n instanceof a.Point &&
                n.series &&
                n.series.chart &&
                (n.series.chart.runTrackerClick = !0);
            t && t.call(n, f, e, !1);
            x[f] || (x[f] = []);
            x[f].push(e);
            u &&
        ...
        a.fireEvent = function(n, f, e, u) {
            var x, t, w, y, c;
            e = e || {};
            F.createEvent && (n.dispatchEvent || n.fireEvent)
                ? ((x = F.createEvent("Events")),
                  x.initEvent(f, !0, !0),
                  a.extend(x, e),
                  n.dispatchEvent ? n.dispatchEvent(x) : n.fireEvent(f, x))
                : a.each(["protoEvents", "hcEvents"], function(h) {
                      if (n[h])
                          for (
                              t = n[h][f] || [],
                                  w = t.length,
        ...
        a.animate = function(n, f, e) {
            ...
            a.isObject(e) ||
                ((y = arguments),
                (e = { duration: y[2], easing: y[3], complete: y[4] }));
            ...
            a.objectEach(f, function(c, h) {
                ...
                t = null;
                "d" === h
                    ? ((w.paths = w.initPath(n, n.d, f.d)),
                      (w.toD = f.d),
                      (u = 0),
                      (t = 1))
                    : n.attr
                    ? (u = n.attr(h))
                    : ((u = parseFloat(a.getStyle(n, h)) || 0),
                      "opacity" !== h && (x = "px"));
                t || (t = c);
        ...
        I.jQuery &&
            (I.jQuery.fn.highcharts = function() {
                ...
                if (this[0])
                    return n[0]
                        ? (new a[a.isString(n[0]) ? n.shift() : "Chart"](
                          ...
                          this)
                        : C[a.attr(this[0], "data-highcharts-chart")];
            });
    })(K);
    (function(a) {
        var C = a.each,
        ...
        a.Color.prototype = {
            ...
            init: function(e) {
                ...
                if (
                    ...
                    this.stops = I(e.stops, function(e) {
            ...
            tweenTo: function(a, f) {
                ...
                t.length && e && e.length
                    ? ((a = 1 !== t[3] || 1 !== e[3]),
                      (f =
                          (a ? "rgba(" : "rgb(") +
                          Math.round(t[0] + (e[0] - t[0]) * (1 - f)) +
                          "," +
                          Math.round(t[1] + (e[1] - t[1]) * (1 - f)) +
                          "," +
                          Math.round(t[2] + (e[2] - t[2]) * (1 - f)) +
                          (a ? "," + (t[3] + (e[3] - t[3]) * (1 - f)) : "") +
                          ")"))
                    : (f = a.input || "none");
                return f;
    ...
    (function(a) {
        ...
        k(C.prototype, {
            ...
            init: function(a, g) {
                this.element =
                    "span" === g ? t(g) : h.createElementNS(this.SVG_NS, g);
                this.renderer = a;
            },
            animate: function(z, g, r) {
                g = a.animObject(E(g, this.renderer.globalAnimation, !0));
                0 !== g.duration
                    ? (r && (g.complete = r), n(this, z, g))
                    : (this.attr(z, null, r), g.step && g.step.call(this));
                return this;
            },
            complexColor: function(z, g, r) {
                ...
                a.fireEvent(
                    ...
                    function() {
                        z.radialGradient
                            ? (m = "radialGradient")
                            : z.linearGradient && (m = "linearGradient");
                        m &&
                            ((d = z[m]),
                            (c = b.gradients),
                            (q = z.stops),
            ...
            attr: function(a, g, r, b) {
                ...
                "string" === typeof a &&
                    ...
                    ((z = a), (a = {}), (a[z] = g));
                "string" === typeof a
                    ? (k = (this[a + "Getter"] || this._defaultGetter).call(
                          this,
                          a,
                          d
                      ))
            ...
            updateShadows: function(a, g, r) {
                for (var z = this.shadows, d = z.length; d--; )
                    r.call(
                        z[d],
                        "height" === a
                            ? Math.max(g - (z[d].cutHeight || 0), 0)
                            : "d" === a
                            ? this.d
                            : g,
                        a,
            ...
            symbolAttr: function(a) {
                ...
                z.attr({
                    d: z.renderer.symbols[z.symbolName](
                        z.x,
                        z.y,
                        z.width,
                        z.height,
                ...
                H &&
                    ...
                    a &&
                        (null === a.width || "auto" === a.width
                            ...
                            : "text" === d.nodeName.toLowerCase() &&
                              a.width &&
                              (b = this.textWidth = g(a.width))),
                    (this.styles = a),
                    b && !O && this.renderer.forExport && delete a.width,
                    ...
                    ? ((r.ontouchstart = function(a) {
                      ...
                      (r.onclick = function(a) {
                          (-1 === Q.navigator.userAgent.indexOf("Android") ||
                              1100 < Date.now() - (z.touchEventFired || 0)) &&
                              g.call(r, a);
                      }))
                    : (r["on" + a] = g);
                return this;
            ...
            setRadialReference: function(a) {
                ...
                z &&
                    z.radAttr &&
                    z.animate(this.renderer.getRadialAttr(a, z.radAttr));
                return this;
            },
                    ...
                    : m &&
                      a.push(
                          "rotate(" +
                              m +
                              " " +
                              E(this.rotationOriginX, c.getAttribute("x"), 0) +
                              " " +
                              E(
            ...
            getBBox: function(a, g) {
                ...
                w(H) &&
                    ((l = H.toString()),
                    -1 === l.indexOf("\x3c") && (l = l.replace(/[0-9]/g, "0")),
                    (l += [
                        "",
                        g || 0,
                        c,
                        ...
                        v &&
                            (z.height = r =
                                { "11px,17": 14, "13px,20": 16 }[
                                    m && m.fontSize + "," + Math.round(r)
                                ] || r),
                        g &&
                            ((z.width =
                                Math.abs(r * Math.sin(d)) +
                                Math.abs(a * Math.cos(d))),
                            (z.height =
                                Math.abs(r * Math.cos(d)) +
            ...
            destroy: function() {
                ...
                b &&
                    d &&
                    (p(d.querySelectorAll("[clip-path],[CLIP-PATH]"), function(
                        a
                    ) {
                        ...
                        (b = m.cloneNode(0)),
                            ...
                            r &&
                                (f(
                                    b,
                                    "height",
                                    Math.max(f(b, "height") - k, 0)
                                ),
                                (b.cutHeight = k)),
                            g
                                ? g.element.appendChild(b)
                                : m.parentNode &&
            ...
            titleSetter: function(a) {
                ...
                g ||
                    ((g = h.createElementNS(this.SVG_NS, "title")),
            ...
            fillSetter: function(a, g, r) {
                "string" === typeof a
                    ? r.setAttribute(g, a)
                    : a && this.complexColor(a, g, r);
            },
            visibilitySetter: function(a, g, r) {
                "inherit" === a
                    ? r.removeAttribute(g)
                    : this[g] !== a && r.setAttribute(g, a);
                this[g] = a;
            },
            zIndexSetter: function(a, r) {
                ...
                var h;
                w(a)
                    ? (k.setAttribute("data-z-index", a),
                      (a = +a),
                      this[r] === a && (m = !1))
                    : w(this[r]) && k.removeAttribute("data-z-index");
                this[r] = a;
                if (m) {
                    ...
                    for (h = r.length - 1; 0 <= h && !c; h--)
                        if (
                            ((d = r[h]),
                            (m = d.getAttribute("data-z-index")),
                            (H = !w(m)),
                            d !== k)
                        )
                            if (0 > a && H && !z && !h)
                                b.insertBefore(k, r[h]), (c = !0);
                            else if (g(m) <= a || (H && (!w(a) || 0 <= a)))
                                b.insertBefore(k, r[h + 1] || null), (c = !0);
        ...
        C.prototype.translateXSetter = C.prototype.translateYSetter = C.prototype.rotationSetter = C.prototype.verticalAlignSetter = C.prototype.rotationOriginXSetter = C.prototype.rotationOriginYSetter = C.prototype.scaleXSetter = C.prototype.scaleYSetter = C.prototype.matrixSetter = function(
            a,
            g
        ) {
            this[g] = a;
        ...
        C.prototype["stroke-widthSetter"] = C.prototype.strokeSetter = function(
            ...
            this.stroke && this["stroke-width"]
                ? (C.prototype.fillSetter.call(this, this.stroke, "stroke", r),
        ...
        k(F.prototype, {
            ...
            init: function(a, g, r, d, b, k) {
                ...
                this.alignedObjects = [];
                this.url =
                    (l || m) && h.getElementsByTagName("base").length
                        ? Q.location.href
                              .split("#")[0]
                              .replace(/<[^>]*>/g, "")
                              .replace(/([\('\)])/g, "\\$1")
                ...
                this.createElement("desc")
                    .add()
                    .element.appendChild(
                        h.createTextNode("Created with Highcharts 6.2.0")
                    );
                ...
                l &&
                    ...
                    g(),
                    (this.unSubPixelFix = I(Q, "resize", g)));
            },
            getStyle: function(a) {
                return (this.style = k(
                    {
                        ...
                        if (void 0 === p[c])
                            if (g.getSubStringLength)
                                try {
                                    p[c] =
                                        b +
                                        g.getSubStringLength(0, d ? c + 1 : c);
                                } catch (Y) {}
                            else
                                z.getSpanWidth &&
                                    (l(k(r || d, m)),
                                    (p[c] = b + z.getSpanWidth(a, g)));
                        return p[c];
                    },
                    G,
                    M;
            ...
            buildText: function(a) {
                var r = a.element,
                    ...
                    w = function(a) {
                        var d;
                        d = /(px|em)$/.test(a && a.style.fontSize)
                            ? a.style.fontSize
                            : y || b.style.fontSize || 12;
                        return M
                            ? g(M)
                            : b.fontMetrics(d, a.getAttribute("style") ? a : r)
                                  .h;
                    },
                    Q = function(a, g) {
                    ...
                    z || e || B || G || -1 !== c.indexOf(" ")
                        ? (l && l.appendChild(r),
                          ...
                          B &&
                              ...
                              a.attr(
                                  "title",
                                  Q(a.textStr, ["\x26lt;", "\x26gt;"])
                              ),
                          l && l.removeChild(r),
                          e && a.applyTextOutline && a.applyTextOutline(e))
                        : r.appendChild(h.createTextNode(Q(c)));
                }
            },
            ...
            button: function(a, g, r, d, b, c, m, H, h) {
                ...
                z.attr(b).css(k({ cursor: "default" }, A));
            ...
            arc: function(a, g, r, d, b, c) {
                B(a)
                    ? ((d = a), (g = d.y), (r = d.r), (a = d.x))
                    : (d = { innerR: d, start: b, end: c });
            ...
            symbol: function(a, g, r, d, b, c) {
                ...
                z
                    ? ((H = this.path(l)),
                      H.attr("fill", "none"),
                      k(H, { symbolName: v, x: g, y: r, width: d, height: b }),
                      c && k(H, c))
                    : A &&
                      ((G = a.match(q)[1]),
                      (H = this.image(G)),
                      (H.imgwidth = E(R[G] && R[G].width, c && c.width)),
                      (H.imgheight = E(R[G] && R[G].height, c && c.height)),
                      (M = function() {
                          H.attr({ width: H.width, height: H.height });
                      }),
            ...
            symbols: {
                ...
                arc: function(a, g, r, d, b) {
                    ...
                    d = E(
                        b.open,
                        0.001 > Math.abs(b.end - b.start - 2 * Math.PI)
                    );
                    var h = Math.cos(c),
                        q = Math.sin(c),
                        A = Math.cos(k),
                        k = Math.sin(k);
                    b = 0.001 > b.end - c - Math.PI ? 0 : 1;
                    m = [
                        "M",
                        a + m * h,
                        g + H * q,
            ...
            text: function(a, g, r, d) {
                ...
                if (d && (this.allowHTML || !this.forExport))
                    return this.html(a, g, r);
                b.x = Math.round(g || 0);
                r && (b.y = Math.round(r));
                w(a) && (b.text = a);
                a = this.createElement("text").attr(b);
                d ||
                    (a.xSetter = function(a, g, r) {
                        ...
                        for (m = 0; m < d.length; m++)
                            (b = d[m]),
                                b.getAttribute(g) === c && b.setAttribute(g, a);
                        r.setAttribute(g, a);
                    });
                return a;
            },
            fontMetrics: function(a, r) {
                a =
                    a ||
                    (r && r.style && r.style.fontSize) ||
                    (this.style && this.style.fontSize);
                a = /px/.test(a)
                    ? g(a)
                    : /em/.test(a)
                    ? parseFloat(a) *
                      (r ? this.fontMetrics(null, r.parentNode).f : 16)
                    : 12;
                r = 24 > a ? a + 3 : Math.round(1.2 * a);
                return { h: r, b: Math.round(0.8 * r), f: a };
            },
            rotCorr: function(a, g, r) {
                var d = a;
                g && r && (d = Math.max(d * Math.cos(g * y), 4));
                return { x: (-a / 3) * Math.sin(g * y), y: d };
            },
            label: function(g, d, b, c, m, H, h, q, A) {
                var v = this,
                    l = v.g("button" !== A && "label"),
                    M = (l.text = v.text("", 0, 0, h).attr({ zIndex: 1 })),
                    O,
                    z,
                    e = 0,
                    B = 3,
                ...
                n = function() {
                    ...
                    u &&
                        (O ||
                            ((l.box = O =
                                v.symbols[c] || Q ? v.symbol(c) : v.rect()),
                            O.addClass(
                                ("button" === A ? "" : "highcharts-label-box") +
                                    (A ? " highcharts-" + A + "-box" : "")
                            ),
                            O.add(l),
                            (a = L()),
                            (g.x = a),
                            (g.y = (q ? -x : 0) + a)),
                        (g.width = Math.round(l.width)),
                        (g.height = Math.round(l.height)),
                        O.attr(k(g, E)),
                        (E = {}));
                };
                P = function() {
                    ...
                    w(f) &&
                        z &&
                        ("center" === J || "right" === J) &&
                        (a += { center: 0.5, right: 1 }[J] * (f - z.width));
                    if (a !== M.x || g !== M.y)
                        M.attr("x", a),
                            M.hasBoxWidthChanged && ((z = M.getBBox(!0)), n()),
                            void 0 !== g && M.attr("y", g);
                    M.x = a;
                    M.y = g;
                };
                ...
                l.onAdd = function() {
                    M.add(l);
                    l.attr({ text: g || 0 === g ? g : "", x: d, y: b });
                    O && w(m) && l.attr({ anchorX: m, anchorY: H });
                };
    ...
    (function(a) {
        ...
        e(a.SVGElement.prototype, {
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    var a = this.renderer,
                        ...
                        e = { left: 0, center: 0.5, right: 1 }[l],
                        B = this.styles,
                        t = B && B.whiteSpace;
                    I(c, { marginLeft: d, marginTop: b });
                    this.shadows &&
                        f(this.shadows, function(a) {
                            I(a, { marginLeft: d + 1, marginTop: b + 1 });
                        });
                    this.inverted &&
                        f(c.childNodes, function(d) {
                            a.invertChild(d, c);
                        });
                    if ("SPAN" === c.tagName) {
                        var B = this.rotation,
                            ...
                            A;
                        (A = m !== this.oldTextWidth) &&
                            !(A = m > this.oldTextWidth) &&
                            ((A = this.textPxLength) ||
                                (I(c, { width: "", whiteSpace: t || "nowrap" }),
                                (A = c.offsetWidth)),
                            (A = A > m));
                        A && /[ \-]/.test(c.textContent || c.innerText)
                            ? (I(c, {
                                  width: m + "px",
                                  display: "block",
                                  whiteSpace: t || "normal"
                        ...
                        G !== this.cTT &&
                            ((t = a.fontMetrics(c.style.fontSize).b),
                            !n(B) ||
                                (B === (this.oldRotation || 0) &&
                                    l === this.oldAlign) ||
                                this.setSpanRotation(B, e, t),
                            this.getSpanCorrection(
                                (!n(B) && this.textPxLength) || c.offsetWidth,
                                t,
                                e,
                                B,
                                l
            ...
            setSpanRotation: function(a, c, d) {
                ...
                b[k + (u ? "Origin" : "-origin")] = b.transformOrigin =
                    100 * c + "% " + d + "px";
                I(this.element, b);
            },
        ...
        e(c.prototype, {
            getTransformKey: function() {
                return x && !/Edge/.test(h.navigator.userAgent)
                    ? "-ms-transform"
                    : t
                    ? "-webkit-transform"
                    : u
            ...
            html: function(a, c, d) {
                ...
                b.xSetter = b.ySetter = b.alignSetter = b.rotationSetter = function(
                    a,
                    d
                ) {
                    "align" === d && (d = "textAlign");
                    ...
                    ? ((this.get = function(a, c) {
                      ...
                      (this.set = function(a, c, h) {
                          ...
                          if (
                              ...
                              "Seconds" === a ||
                              ("Minutes" === a &&
                                  0 === c.getTimezoneOffset() % 60)
                          )
                              c["set" + a](h);
                          else
                              (p = w.getTimezoneOffset(c)),
                                  (p = c.getTime() - p),
                                  c.setTime(p),
                                  c["setUTC" + a](h),
            ...
            makeTime: function(e, t, w, y, c, h) {
                ...
                this.useUTC
                    ? ((p = this.Date.UTC.apply(0, arguments)),
                      (k = this.getTimezoneOffset(p)),
                      (p += k),
                      (q = this.getTimezoneOffset(p)),
                      k !== q
                          ? (p += q - k)
                          : k - 36e5 !== this.getTimezoneOffset(p - 36e5) ||
                            a.isSafari ||
                            (p -= 36e5))
                    : (p = new this.Date(
                          e,
            ...
            dateFormat: function(e, f, w) {
                ...
                a.objectEach(c, function(a, d) {
                    for (; -1 !== e.indexOf("%" + d); )
                        e = e.replace(
                            "%" + d,
                            "function" === typeof a ? a.call(t, f) : a
                        );
                });
                return w ? e.substr(0, 1).toUpperCase() + e.substr(1) : e;
            },
            resolveDTLFormat: function(e) {
                return a.isObject(e, !0)
                    ? e
                    : ((e = a.splat(e)), { main: e[0], from: e[1], to: e[2] });
            },
            getTimeTicks: function(a, t, w, y) {
                ...
                if (C(t)) {
                    c.set(
                        ...
                        d >= e.second
                            ? 0
                            : b * Math.floor(c.get("Milliseconds", p) / b)
                    );
                    d >= e.second &&
                        c.set(
                            "Seconds",
                            ...
                            d >= e.minute
                                ? 0
                                : b * Math.floor(c.get("Seconds", p) / b)
                        );
                    d >= e.minute &&
                        c.set(
                            "Minutes",
                            ...
                            d >= e.hour
                                ? 0
                                : b * Math.floor(c.get("Minutes", p) / b)
                        );
                    d >= e.hour &&
                        c.set(
                            "Hours",
                    ...
                    c.variableTimezone &&
                        (v =
                            w - t > 4 * e.month ||
                            c.getTimezoneOffset(t) !== c.getTimezoneOffset(w));
                    t = p.getTime();
                    for (p = 1; t < w; )
                        h.push(t),
                            (t =
                    ...
                    d <= e.hour &&
                        ...
                        F(h, function(a) {
                            0 === a % 18e5 &&
                                "000000000" === c.dateFormat("%H%M%S%L", a) &&
                                (k[a] = "day");
                        });
                }
                h.info = I(a, { higherRanks: k, totalRange: d * b });
                return h;
            }
        };
    })(K);
    (function(a) {
        ...
        a.setOptions = function(C) {
            ...
            a.time.update(
                F(a.defaultOptions.global, a.defaultOptions.time),
                !1
            );
    ...
    (function(a) {
        ...
        a.Tick.prototype = {
            addLabel: function() {
                ...
                w.isDatetimeAxis &&
                    d &&
                    ((n = c.time.resolveDTLFormat(
                        y.dateTimeLabelFormats[
                            (!y.grid && d.higherRanks[k]) || d.unitName
                        ]
                    )),
                    (l = n.main));
                f.isFirst = b;
                ...
                if ((D = n && n.list))
                    f.shortenLabel = function() {
                        for (B = 0; B < D.length; B++)
                            if (
                                (J.attr({
                                    text: w.labelFormatter.call(
                                        a.extend(f.formatCtx, {
                                            dateTimeLabelFormat: D[B]
                                        })
                                    )
                                }),
                                J.getBBox().width <
                                    w.getSlotWidth(f) - 2 * u(q.padding, 5))
                            )
                                return;
                        J.attr({ text: "" });
                    };
            ...
            handleOverflow: function(a) {
                var e = this.axis,
                    ...
                    B,
                    D = {};
                if (d || "justify" !== u(f.overflow, "justify"))
                    0 > d && c - b * v < k
                        ? (B = Math.round(c / Math.cos(d * x) - k))
                        : 0 < d &&
                          c + b * v > p &&
                          (B = Math.round((h - c) / Math.cos(d * x)));
                else if (
                    ((h = c + (1 - b) * v),
                    c - b * v < k
                        ? (l = a.x + l * (1 - b) - k)
                    ...
                    l < J &&
                        "center" === e.labelAlign &&
                        (a.x += t * (J - l - b * (J - Math.min(v, l)))),
                    v > l || (e.autoRotation && (q.styles || {}).width))
                )
                    B = l;
                B &&
                    (this.shortenLabel
            ...
            getPosition: function(e, f, y, c) {
                ...
                e = {
                    x: e
                        ? a.correctFloat(
                              h.translate(f + y, null, null, c) + h.transB
                          )
                        : h.left +
                          h.offset +
                          (h.opposite
                              ? ((c && p.oldChartWidth) || p.chartWidth) -
                                h.right -
                                h.left
                              : 0),
                    y: e
                        ? k - h.bottom + h.offset - (h.opposite ? h.height : 0)
                        : a.correctFloat(
                              k - h.translate(f + y, null, null, c) - h.transB
                          )
                };
            ...
            getLabelPosition: function(a, e, f, c, h, p, k, q) {
                var d = this.axis,
                    ...
                    v = d.reversed,
                    J = d.staggerLines,
                    l = d.tickRotCorr || { x: 0, y: 0 },
                    t = h.y,
                    B =
                        c || d.reserveSpaceDefault
                            ? 0
                            : -d.labelOffset *
                ...
                F(t) ||
                    (t =
                        0 === d.side
                            ...
                            : 2 === d.side
                            ? l.y + 8
                            : Math.cos(f.rotation * x) *
                              (l.y - f.getBBox(!1, 0).height / 2));
                ...
                d &&
                    ...
                    v &&
                        ((this.mark = b = p
                            ...
                            .add(c.axisGroup)),
                        b.attr({ stroke: h, "stroke-width": l })),
                    b[v ? "attr" : "animate"]({
                        d: this.getMarkPath(
                            J,
                            a,
            ...
            renderLabel: function(a, e, y, c) {
                ...
                q &&
                    f(J) &&
                    ((q.xy = a = this.getLabelPosition(J, a, q, p, d, h, c, b)),
                    (this.isFirst && !this.isLast && !u(k.showFirstLabel, 1)) ||
                    (this.isLast && !this.isFirst && !u(k.showLastLabel, 1))
                        ? (v = !1)
                        : !p ||
                          d.step ||
                          d.rotation ||
                    ...
                    v && f(a.y)
                        ? ((a.opacity = y),
                          q[this.isNewLabel ? "attr" : "animate"](a),
                          (this.isNewLabel = !1))
    ...
    var W = (function(a) {
        ...
        a.extend(E.prototype, {
            ...
            init: function(a, r) {
                ...
                b.side =
                    r.side ||
                    (b.horiz ? (b.opposite ? 0 : 2) : b.opposite ? 1 : 3);
                b.setOptions(r);
                var c = this.options,
                    m = c.type;
                b.labelFormatter =
                    c.labels.formatter || b.defaultLabelFormatter;
                b.userOptions = r;
                b.minPixelPadding = 0;
                ...
                b.crosshair = D(
                    c.crosshair,
                    G(a.options.tooltip.crosshairs)[g ? 0 : 1],
                    !1
                );
                r = b.options.events;
                -1 === d(b, a.axes) &&
                    (g ? a.axes.splice(a.xAxis.length, 0, b) : a.axes.push(b),
                    a[b.coll].push(b));
                b.series = b.series || [];
                a.inverted &&
                    !b.isZAxis &&
                    ...
                    for (; h-- && void 0 === l; )
                        (b = Math.pow(m, h + 1)),
                            g >= b &&
                                ...
                                null !== k[h] &&
                                0 !== r &&
                                (l = a.numberFormat(r / b, -1) + k[h]);
                void 0 === l &&
                    (l =
                        1e4 <= Math.abs(r)
                            ? a.numberFormat(r, -1)
                            : a.numberFormat(r, -1, void 0, ""));
                return l;
            },
                    ...
                    y(a.series, function(g) {
                        if (g.visible || !r.options.chart.ignoreHiddenSeries) {
                            ...
                            if (a.isXAxis)
                                ...
                                x(g) &&
                                    x(c) &&
                                    ((a.dataMin = Math.min(D(a.dataMin, g), g)),
                                    (a.dataMax = Math.max(D(a.dataMax, c), c))),
                                x(d) && (a.threshold = d),
            ...
            translate: function(a, r, b, d, c, m) {
                ...
                r
                    ? ((a = (a * k + H - h) / l + d), c && (a = g.lin2val(a)))
                    : (c && (a = g.val2lin(a)),
                      (a = v(d)
                          ? k * (a - d) * l + H + k * h + (v(m) ? l * m : 0)
                          : void 0));
                return a;
            },
            ...
            getPlotLinePath: function(a, r, b, d, c) {
                ...
                var e = function(a, g, r) {
                    if (("pass" !== d && a < g) || a > r)
                        d ? (a = Math.min(Math.max(g, a), r)) : (A = !0);
                    return a;
                };
                ...
                v(c)
                    ? this.horiz
                        ? ((H = k),
                          (l = h - this.bottom),
                          (a = b = e(a, m, m + this.width)))
                        : ((a = m),
                          (b = q - this.right),
                          (H = l = e(H, k, k + this.height)))
                    : ((A = !0), (d = !1));
                return A && !d
                    ? null
                    : g.renderer.crispLine(["M", a, H, "L", b, l], r || 1);
            },
            ...
            getMinorTickPositions: function() {
                ...
                if (l && l / d < a.len / 3)
                    if (a.isLog)
                        y(this.paddedTicks, function(g, r, b) {
                            r &&
                                c.push.apply(
                                    c,
            ...
            nameToX: function(a) {
                ...
                void 0 !== k &&
                    ((this.names[k] = a.name), (this.names.keys[a.name] = k));
                return k;
            },
            ...
            setAxisTranslation: function(a) {
                ...
                if (A || q || d)
                    (c = g.getClosest()),
                        l
                            ? ((m = l.minPointOffset),
                              (k = l.pointRangePadding))
                            : y(g.series, function(a) {
                                  var b = q
                                      ? 1
                                      : A
                                      ? D(a.options.pointRange, c, 0)
                                      : g.axisPointRange || 0;
                                  a = a.options.pointPlacement;
                                  d = Math.max(d, b);
                                  g.single ||
                                      ((m = Math.max(m, J(a) ? 0 : b / 2)),
                                      (k = Math.max(k, "on" === a ? 0 : b)));
                              }),
                        (l = g.ordinalSlope && c ? g.ordinalSlope / c : 1),
                        (g.minPointOffset = m *= l),
                        (g.pointRangePadding = k *= l),
                        (g.pointRange = Math.min(d, b)),
                        A && (g.closestPointRange = c);
                a && (g.oldTransA = v);
                g.translationSlope = g.transA = v =
                    g.staticScale || g.len / (b + k || 1);
            ...
            setTickInterval: function(g) {
                ...
                A
                    ? ((b.linkedParent = d[b.coll][c.linkedTo]),
                      ...
                      (b.min = D(d.min, d.dataMin)),
                      (b.max = D(d.max, d.dataMax)),
                      c.type !== b.linkedParent.options.type && a.error(11, 1))
                    : (!N &&
                          x(E) &&
                          (b.dataMin >= E
                              ? ((w = E), (f = 0))
                              : b.dataMax <= E && ((t = E), (p = 0))),
                      (b.min = D(u, w, b.dataMin)),
                      (b.max = D(n, t, b.dataMax)));
                m &&
                    (b.positiveValuesOnly &&
                        !g &&
                        0 >= Math.min(b.min, D(b.dataMin, b.min)) &&
                        a.error(10, 1),
                    (b.min = e(b.log2lin(b.min), 15)),
                    (b.max = e(b.log2lin(b.max), 15)));
                b.range &&
                    x(b.max) &&
                    ((b.userMin = b.min = u = Math.max(
                        b.dataMin,
                        b.minFromRange()
                    )),
                    (b.userMax = n = b.max),
                ...
                b.adjustForMinRange();
                !(J || b.axisPointRange || b.usePercentage || A) &&
                    x(b.min) &&
                    x(b.max) &&
                    (d = b.max - b.min) &&
                    (!x(u) && f && (b.min -= d * f),
                ...
                v(c.softMin) &&
                    !v(b.userMin) &&
                    (b.min = Math.min(b.min, c.softMin));
                v(c.softMax) &&
                    !v(b.userMax) &&
                    (b.max = Math.max(b.max, c.softMax));
                v(c.floor) && (b.min = Math.max(b.min, c.floor));
                v(c.ceiling) && (b.max = Math.min(b.max, c.ceiling));
                N &&
                    x(b.dataMin) &&
                    ((E = E || 0),
                    !x(u) && b.min < E && b.dataMin >= E
                        ? (b.min = E)
                        : !x(n) && b.max > E && b.dataMax <= E && (b.max = E));
                b.tickInterval =
                    b.min === b.max || void 0 === b.min || void 0 === b.max
                        ? 1
                        : A &&
                          !G &&
                          B === b.linkedParent.options.tickPixelInterval
                        ? (G = b.linkedParent.tickInterval)
                        : D(
                              G,
                              this.tickAmount
                                  ? (b.max - b.min) /
                                  ...
                                  : void 0,
                              J ? 1 : ((b.max - b.min) * B) / Math.max(b.len, B)
                          );
                q &&
                    !g &&
                    y(b.series, function(a) {
                        a.processData(b.min !== b.oldMin || b.max !== b.oldMax);
                    });
                b.setAxisTranslation(!0);
                b.beforeSetTickPositions && b.beforeSetTickPositions();
                b.postProcessTickInterval &&
                    (b.tickInterval = b.postProcessTickInterval(
                        b.tickInterval
                    ));
                b.pointRange &&
                    !G &&
            ...
            setTickPositions: function() {
                ...
                this.tickmarkOffset =
                    this.categories &&
                    "between" === g.tickmarkPlacement &&
                    1 === this.tickInterval
                        ? 0.5
                        : 0;
                this.minorTickInterval =
                    "auto" === b && this.tickInterval
                        ? this.tickInterval / 5
                        : b;
                this.single =
                    this.min === this.max &&
                ...
                !b &&
                    ...
                    (this.max - this.min) / this.tickInterval >
                        ...
                        ? ((b = [this.min, this.max]), a.error(19))
            ...
            trimTicks: function(a, b, d) {
                ...
                if (!this.isLinked) {
                    ...
                    else for (; this.min - m > a[0]; ) a.shift();
                    if (d) this.max = c;
                    else for (; this.max + m < a[a.length - 1]; ) a.pop();
                    0 === a.length &&
                        x(g) &&
            ...
            alignToOthers: function() {
                ...
                !1 === this.chart.options.chart.alignTicks ||
                    ...
                    !1 === d.endOnTick ||
                    this.isLog ||
                    y(this.chart[this.coll], function(g) {
                        var d = g.options,
                            d = [
                                g.horiz ? d.left : d.top,
                                d.width,
                                d.height,
                                d.pane
                            ].join();
            ...
            adjustTickAmount: function() {
                ...
                if (this.hasData()) {
                    if (m < d) {
                        for (; b.length < d; )
                            b.length % 2 || this.min === k
                                ? b.push(e(b[b.length - 1] + a))
                                : b.unshift(e(b[0] - a));
                        this.transA *= (m - 1) / (d - 1);
                        this.min = b[0];
            ...
            setAxisSize: function() {
                var b = this.chart,
                    ...
                    k = (this.width = Math.round(
                        a.relativeLength(
                            D(d.width, b.plotWidth - c[3] + c[1]),
                            b.plotWidth
                        )
                    )),
                    l = (this.height = Math.round(
                        a.relativeLength(
                            D(d.height, b.plotHeight - c[0] + c[2]),
                            b.plotHeight
                        )
                    )),
                    h = (this.top = Math.round(
                        a.relativeLength(
                            D(d.top, b.plotTop + c[0]),
                            b.plotHeight,
                            b.plotTop
                        )
                    )),
            ...
            unsquish: function() {
                ...
                b
                    ? (A =
                          ...
                          (x(l)
                              ? [l]
                              : m < D(a.autoRotationLimit, 80) &&
                                a.autoRotation)) &&
                      y(A, function(a) {
                          var b;
                          if (a === l || (a && -90 <= a && 90 >= a))
                              (q = p(Math.abs(h.h / Math.sin(t * a)))),
                                  (b = q + Math.abs(a / 360)),
                                  b < v && ((v = b), (k = a), (c = q));
                      })
                    : a.step || (c = p(h.h));
            ...
            getSlotWidth: function(a) {
                ...
                return (
                    ...
                    (g &&
                        2 > (d.step || 0) &&
                        !d.rotation &&
                        ((this.staggerLines || 1) * this.len) / c) ||
                    (!g &&
                        ((d.style && parseInt(d.style.width, 10)) ||
                            (m && m - b.spacing[3]) ||
                            0.33 * b.chartWidth))
                );
            },
            renderUnsquish: function() {
                ...
                y(d, function(a) {
                    (a = c[a]) &&
                        a.label &&
                        a.label.textPxLength > G &&
                        (G = a.label.textPxLength);
                });
                ...
                if (this.autoRotation)
                    ...
                    for (f = "clip", q = d.length; !l && q--; )
                        if (((B = d[q]), (B = c[B].label)))
                            B.styles && "ellipsis" === B.styles.textOverflow
                                ? B.css({ textOverflow: "clip" })
                                : B.textPxLength > h &&
                                  B.css({ width: h + "px" }),
                                B.getBBox().height >
                                    this.len / d.length - (A.h - A.f) &&
                                    (B.specificTextOverflow = "ellipsis");
                v.rotation &&
                    ((p = G > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : G),
                    e || (f = "ellipsis"));
                if (
                    (this.labelAlign =
                        m.align || this.autoLabelAlign(this.labelRotation))
                )
                        ...
                        b &&
                            ...
                            a.shortenLabel
                                ...
                                : p &&
                                  ...
                                  "nowrap" !== k.whiteSpace &&
                                  (p < b.textPxLength ||
                                      "SPAN" === b.element.tagName)
                                ? ((d.width = p),
                                  e ||
                                      (d.textOverflow =
                                          b.specificTextOverflow || f),
                                  b.css(d))
                                : b.styles &&
                                  b.styles.width &&
                                  !d.width &&
            ...
            getOffset: function() {
                ...
                A || a.isLinked
                    ? (y(m, function(b, g) {
                      ...
                      a.staggerLines && (N *= a.staggerLines),
                ...
                J &&
                    ...
                    e &&
                        !1 !== J.reserveSpace &&
                        ((a.titleOffset = p = a.axisTitle.getBBox()[
                            l ? "height" : "width"
                        ]),
                        (G = J.offset),
                        (f = x(G) ? 0 : D(J.margin, l ? 5 : 10))));
                a.renderLine();
                ...
                N &&
                    (f =
                        f -
                        d +
                        t * (l ? D(E.y, a.tickRotCorr.y + 8 * t) : E.x));
                a.axisTitleMargin = D(G, f);
                a.getMaxLabelDimensions &&
                    (a.maxLabelDimensions = a.getMaxLabelDimensions(k, m));
                l = this.tickSize("tick");
                w[q] = Math.max(
                    w[q],
                    a.axisTitleMargin + p + t * a.offset,
                    f,
                    A && m.length && l ? l[0] + t * a.offset : 0
                );
            ...
            getLinePath: function(a) {
                ...
                return b.renderer.crispLine(
                    [
                        ...
                        c ? d : this.top,
                        "L",
                        c ? b.chartWidth - this.right : m,
                        c ? d : b.chartHeight - this.bottom
                    ],
                    a
                );
            },
            ...
            getTitlePosition: function() {
                var a = this.horiz,
                    ...
                    v = m.y || 0,
                    A = this.axisTitle,
                    e = this.chart.renderer.fontMetrics(
                        m.style && m.style.fontSize,
                        A
                    ),
            ...
            render: function() {
                ...
                if (b.hasData() || k)
                    b.minorTickInterval &&
                        !b.categories &&
                        y(b.getMinorTickPositions(), function(a) {
                            b.renderMinorTick(a);
                        }),
                        l.length &&
                            (y(l, function(a, d) {
                        ...
                        b._addedPlotLB ||
                            (y(
                                (c.plotLines || []).concat(c.plotBands || []),
                                function(a) {
                ...
                y([e, p, f], function(a) {
                    ...
                    B(a, function(a, b) {
                        a.isActive ||
                            (a.render(b, !1, 0), (a.isActive = !1), c.push(b));
                    });
                    A(
                        function() {
                            for (b = c.length; b--; )
                ...
                q &&
                    ...
                    v(c.y)
                        ? (q[q.isNew ? "attr" : "animate"](c), (q.isNew = !1))
            ...
            destroy: function(a) {
                ...
                for (k in b.plotLinesAndBandsGroups)
                    b.plotLinesAndBandsGroups[k] = b.plotLinesAndBandsGroups[
                        k
                    ].destroy();
                B(b, function(a, c) {
            ...
            drawCrosshair: function(a, b) {
                ...
                if (this.crosshair && !1 !== (x(b) || !g)) {
                    ...
                    x(m) &&
                        (d =
                            this.getPlotLinePath(
                                b && (this.isXAxis ? b.x : D(b.stackY, b.y)),
                                null,
                                null,
                                null,
                                m
                    ...
                    k ||
                        ((this.cross = k = this.chart.renderer
                            .path()
                            .addClass(
                    ...
                    k.show().attr({ d: d });
                    g && !c.width && k.attr({ "stroke-width": this.transA });
                    this.cross.e = a;
    ...
    (function(a) {
        ...
        C.prototype.normalizeTimeTickInterval = function(a, e) {
            ...
            for (
                ...
                (x = n[e[0]]),
                (t = e[1]),
                f[w + 1] && a <= (x * t[t.length - 1] + n[f[w + 1][0]]) / 2);
                w++
            );
            x === n.year && a < 5 * x && (t = [1, 2, 5]);
            a = I(a / x, t, "year" === e[0] ? Math.max(F(a / x), 1) : 1);
            return { unitRange: x, count: a, unitName: e[0] };
        };
    })(K);
    (function(a) {
        var C = a.Axis,
        ...
        C.prototype.getLogTickPositions = function(a, u, x, t) {
            ...
            if (0.5 <= a)
                (a = Math.round(a)), (c = this.getLinearTickPositions(a, u, x));
            else if (0.08 <= a)
                for (
                    var y = Math.floor(u),
                        h,
                    ...
                    for (p = e.length, h = 0; h < p && !d; h++)
                        (k = this.log2lin(this.lin2log(y) * e[h])),
                            k > u &&
                                (!t || q <= x) &&
                                void 0 !== q &&
                                c.push(q),
                ...
                (u = this.lin2log(u)),
                    (x = this.lin2log(x)),
                    (a = t ? this.getMinorTickInterval() : e.tickInterval),
                    (a = f(
                        "auto" === a ? null : a,
                        this._minorAutoInterval,
                        ((e.tickPixelInterval / (t ? 5 : 1)) * (x - u)) /
                            ((t ? y / this.tickPositions.length : y) || 1)
                    )),
                    (a = n(a, null, F(a))),
                    (c = I(this.getLinearTickPositions(a, u, x), this.log2lin)),
    ...
    (function(a, C) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                J
                    ? ((B.stroke = D),
                      (B["stroke-width"] = h.width),
                      h.dashStyle && (B.dashstyle = h.dashStyle))
                    : v &&
                      (D && (B.fill = D),
                      h.borderWidth &&
                          ((B.stroke = h.borderColor),
                          (B["stroke-width"] = h.borderWidth)));
                A.zIndex = m;
                E += "-" + m;
                (D = f.plotLinesAndBandsGroups[E]) ||
                    (f.plotLinesAndBandsGroups[E] = D = N.g("plot-" + E)
                        .attr(A)
                        .add());
                u &&
                    (e.svgElem = l = N.path()
    ...
    (function(a) {
        ...
        a.Tooltip.prototype = {
            ...
            getLabel: function() {
                ...
                this.label ||
                    (this.outside &&
                        ((this.container = e = a.doc.createElement("div")),
                        ...
                        a.doc.body.appendChild(e),
                        (this.renderer = c = new a.Renderer(e, 0, 0))),
                    this.split
                        ? (this.label = c.g("tooltip"))
                        : ((this.label = c
                              .label(
                                  "",
                                  0,
            ...
            move: function(c, h, e, k) {
                var q = this,
                    ...
                    b =
                        ...
                        !q.isHidden &&
                        (1 < Math.abs(c - d.x) || 1 < Math.abs(h - d.y)),
            ...
            getAnchor: function(a, h) {
                var c = this.chart,
                    ...
                    n;
                a = t(a);
                this.followPointer && h
                    ? (void 0 === h.chartX && (h = k.normalize(h)),
                      (a = [h.chartX - c.plotLeft, h.chartY - d]))
                    : a[0].tooltipPos
                    ? (a = a[0].tooltipPos)
                    : (F(a, function(a) {
                          l = a.series.yAxis;
                          ...
                          f +=
                              (a.plotLow
                                  ...
                                  : a.plotY) + (!q && l ? l.top - d : 0);
                      }),
                      (v /= a.length),
                      (f /= a.length),
                      (a = [
                          q ? c.plotWidth - f : v,
                          this.shared && !q && 1 < a.length && h
                              ? h.chartY - d
                              : q
                              ? c.plotHeight - v
                              : f
            ...
            getPosition: function(a, h, e) {
                var c = this.chart,
                    ...
                    f = this.outside,
                    l = f
                        ? C.documentElement.clientWidth - 2 * q
                        : c.chartWidth,
                    p = f
                        ? Math.max(
                              C.body.scrollHeight,
                    ...
                    D = [
                        ...
                        p,
                        h,
                        (f ? B.top - q : 0) + e.plotY + c.plotTop,
                        f ? 0 : c.plotTop,
                        f ? p : c.plotTop + c.plotHeight
                    ],
                    m = [
                        "x",
                        l,
                        a,
                        (f ? B.left - q : 0) + e.plotX + c.plotLeft,
                        f ? 0 : c.plotLeft,
                        f ? l : c.plotLeft + c.plotWidth
                    ],
                    G =
                        !this.followPointer &&
                    ...
                    A = function(a, c, g, m, k, l) {
                        ...
                        if (G && v) d[a] = m;
                            ...
                            d[a] = Math.min(l - g, 0 > A - b ? A : A - b);
                        else if (v)
                            d[a] = Math.max(k, m + b + g > c ? m : m + b);
                        else return !1;
                    },
                    N = function(a, b, c, g) {
                        var m;
            ...
            refresh: function(c, h) {
                ...
                k.enabled &&
                    (a.clearTimeout(this.hideTimer),
                    (this.followPointer = t(
                        d
                    )[0].series.tooltipOptions.followPointer),
                    (b = this.getAnchor(d, h)),
                    (h = b[0]),
                    (q = b[1]),
                    !v || (d.series && d.series.noSharedTooltip)
                        ? (v = d.getLabelConfig())
                        : (F(d, function(a) {
                              a.setState("hover");
                    ...
                    (v = e.call(v, this)),
                    (l = d.series),
                    (this.distance = x(l.tooltipOptions.distance, 16)),
                    !1 === v
                        ? this.hide()
                        : ((e = this.getLabel()),
                          this.isHidden && e.attr({ opacity: 1 }).show(),
                          this.split
                              ? this.renderSplit(v, t(c))
                              : (k.style.width ||
                                    e.css({
            ...
            renderSplit: function(c, h) {
                ...
                F(c.slice(0, h.length + 1), function(a, c) {
                    if (!1 !== a) {
                        c = h[c - 1] || { isHeader: !0, plotX: h[0].plotX };
                        var m = c.series || e,
                            A = m.tt,
                            p = c.series || {},
                            E =
                                "highcharts-color-" +
                                x(c.colorIndex, p.colorIndex, "none");
                        A ||
                            (m.tt = A = d
                                .label(
                                    null,
                        ...
                        c.isHeader
                            ? ((f = a.height),
                              q.xAxis[0].opposite && ((l = !0), (B -= f)),
                              (p = Math.max(
                                  0,
                                  Math.min(
                                      c.plotX + q.plotLeft - p / 2,
                                      q.chartWidth +
                                          (q.scrollablePixels
                                              ? q.scrollablePixels -
                                                q.marginRight
                            ...
                            : (p =
                                  c.plotX + q.plotLeft - x(v.distance, 16) - p);
                        0 > p && (b = !1);
                        a =
                ...
                F(k, function(a) {
                    ...
                    a.tt.attr({
                        ...
                        x:
                            b || c.isHeader
                                ? a.x
                                : c.plotX + q.plotLeft + x(v.distance, 16),
                        y: a.pos + B,
                        anchorX: c.isHeader
                            ? c.plotX + q.plotLeft
                            : c.plotX + d.xAxis.pos,
                        anchorY: c.isHeader
                            ? q.plotTop + q.plotHeight / 2
                            : c.plotY + d.yAxis.pos
                    });
                });
            },
            updatePosition: function(a) {
                var c = this.chart,
                    e = this.getLabel(),
                    k = (this.options.positioner || this.getPosition).call(
                        this,
                        e.width,
                        e.height,
                        a
                ...
                this.outside &&
                    ...
                    (q += c.pointer.chartPosition.left - k.x),
            ...
            getDateFormat: function(a, h, e, k) {
                ...
                for (v in y) {
                    ...
                    if (
                        f[v] &&
                        d.substr(f[v]) !== "01-01 00:00:00.000".substr(f[v])
                    )
                        break;
                    "week" !== v && (l = v);
                }
            ...
            getXDateFormat: function(a, h, e) {
                ...
                return (
                    (c
                        ? this.getDateFormat(c, a.x, e.options.startOfWeek, h)
                        : h.day) || h.year
                );
            },
            tooltipFooterHeaderFormatter: function(a, h) {
                ...
                b &&
                    e &&
                    F((a.point && a.point.tooltipDateKeys) || ["key"], function(
                        a
                    ) {
                        v = v.replace(
                            "{point." + a + "}",
                ...
                return n(v, { point: a, series: c }, this.chart.time);
            },
    ...
    (function(a) {
        ...
        a.Pointer.prototype = {
            ...
            getChartCoordinatesFromPoint: function(a, b) {
                ...
                if (d && c)
                    return b
                        ...
                        : { chartX: k + d.pos, chartY: a.plotY + c.pos };
            ...
            runPointActions: function(c, b) {
                var d = this.chart,
                    ...
                    h = this.getHoverData(
                        ...
                        d.series,
                        "touchmove" !== c.type &&
                            (!!b || (h && h.directTouch && this.isDirectTouch)),
                        l,
                        c,
                ...
                if (e && (e !== d.hoverPoint || (k && k.isHidden))) {
                    ...
                    b &&
                        ...
                        !k.isHidden &&
                        ((e = k.getAnchor([{}], c)),
                        k.updatePosition({ plotX: e[0], plotY: e[1] }));
                this.unDocMouseMove ||
            ...
            scaleGroups: function(a, b) {
                ...
                u(c.series, function(k) {
                    ...
                    k.xAxis &&
                        ...
                        (k.group.attr(d),
                        k.markerGroup &&
                            (k.markerGroup.attr(d),
                            k.markerGroup.clip(b ? c.clipRect : null)),
                        k.dataLabelsGroup && k.dataLabelsGroup.attr(d));
                });
            ...
            drag: function(a) {
                ...
                (E && E.touch) ||
                    ...
                    (this.hasDragged = Math.sqrt(
                        Math.pow(g - d, 2) + Math.pow(r - k, 2)
                    )),
                    10 < this.hasDragged &&
                        ((p = b.isInsidePlot(g - q, r - m)),
                        b.hasCartesianSeries &&
                            (this.zoomX || this.zoomY) &&
                            p &&
                            !t &&
                            !E &&
                            (this.selectionMarker = E = b.renderer
                                .rect(q, m, e ? 1 : f, h ? 1 : A, 0)
                                .attr({
                                    fill:
            ...
            drop: function(a) {
                ...
                c &&
                    y(c.index) &&
                    (f(c.container, { cursor: c._cursor }),
            ...
            onContainerMouseMove: function(c) {
                ...
                (e(a.hoverChartIndex) &&
                    I[a.hoverChartIndex] &&
                    I[a.hoverChartIndex].mouseIsDown) ||
            ...
            onContainerClick: function(a) {
                ...
                b.cancelClick ||
                    (c && this.inClass(a.target, "highcharts-tracker")
                        ? (w(c.series, "click", x(a, { point: c })),
                          b.hoverPoint && c.firePointEvent("click", a))
                        : (x(a, this.getCoordinates(a)),
                          b.isInsidePlot(a.chartX - d, a.chartY - k) &&
                              w(b, "click", a)));
            },
            setDOMEvents: function() {
                ...
                this.unbindContainerMouseLeave = C(
                    b,
                    "mouseleave",
                    c.onContainerMouseLeave
                );
                a.unbindDocumentMouseUp ||
                    (a.unbindDocumentMouseUp = C(
                        k,
                        "mouseup",
                        c.onDocumentMouseUp
                    ));
                a.hasTouch &&
                    ...
                    a.unbindDocumentTouchEnd ||
                        (a.unbindDocumentTouchEnd = C(
                            k,
                            "touchend",
                            c.onDocumentTouchEnd
                        )));
            },
            destroy: function() {
                var c = this;
    ...
    (function(a) {
        ...
        I(a.Pointer.prototype, {
            pinchTranslate: function(a, e, f, n, y, c) {
                this.zoomHor &&
                    this.pinchTranslateDirection(!0, a, e, f, n, y, c);
                this.zoomVert &&
                    this.pinchTranslateDirection(!1, a, e, f, n, y, c);
            },
            ...
            pinch: function(a) {
                var u = this,
                    ...
                    d =
                        1 === c &&
                        ((u.inClass(a.target, "highcharts-tracker") &&
                            t.runTrackerClick) ||
                            u.runChartClick),
                    b = {};
                1 < c && (u.initiated = !0);
                ...
                "touchstart" === a.type
                    ? (F(y, function(a, b) {
                      ...
                      (h.x = [w[0].chartX, w[1] && w[1].chartX]),
                      (h.y = [w[0].chartY, w[1] && w[1].chartY]),
                      F(t.axes, function(a) {
                          if (a.zoomEnabled) {
                      ...
                      (u.res = !0))
                    : u.followTouchMove && 1 === c
                    ? this.runPointActions(u.normalize(a))
                    : w.length &&
                      (k ||
                          (u.selectionMarker = k = I(
                              { destroy: f, touch: !0 },
                              t.plotBox
                          )),
                      u.pinchTranslate(w, y, q, k, b, h),
                      (u.hasPinched = p),
                      u.scaleGroups(q, b),
            ...
            f(u.prototype, {
                ...
                onContainerPointerMove: function(a) {
                    p(a, "onContainerTouchMove", "touchmove", function(a) {
                        y[a.pointerId] = { pageX: a.pageX, pageY: a.pageY };
                        y[a.pointerId].target ||
                            (y[a.pointerId].target = a.currentTarget);
                    });
                },
    ...
    (function(a) {
        ...
        a.Legend.prototype = {
            ...
            colorizeItem: function(a, c) {
                ...
                h &&
                    (f &&
                        h.isMarker &&
                        ((p = a.pointAttribs()), c || (p.stroke = p.fill = l)),
                    h.attr(p));
                e(this, "afterColorizeItem", { item: a, visible: c });
            },
            ...
            setText: function(c) {
                ...
                c.legendItem.attr({
                    text: h.labelFormat
                        ? a.format(h.labelFormat, c, this.chart.time)
                        : h.labelFormatter.call(c)
                });
            },
            renderItem: function(a) {
                ...
                m ||
                    ...
                    (a.legendItem = m = d
                        .text("", p ? h + e : -e, this.baseline || 0, E)
                        .css(t(a.visible ? l : k))
                        .attr({ align: p ? "left" : "right", zIndex: 2 })
                        .add(a.legendGroup)),
                    this.baseline ||
                        ((h = l.fontSize),
                        (this.fontMetrics = d.fontMetrics(h, m)),
                        (this.baseline =
                    ...
                    this.setItemEvents && this.setItemEvents(a, m, E),
                    n && this.createCheckboxForItem(a));
                this.colorizeItem(a, a.visible);
                l.width ||
                    m.css({
                        width:
                            (b.itemWidth || b.width || c.spacingBox.width) - f
                    });
                this.setText(a);
                c = m.getBBox();
                a.itemWidth = a.checkboxOffset =
                    b.itemWidth || a.legendItemWidth || c.width + f;
            ...
            layoutItem: function(a) {
                var c = this.options,
                    ...
                    c =
                        c.alignColumns && this.totalItemWidth > p
                            ? this.maxItemWidth
                            : a.itemWidth;
                b &&
                    this.itemX - d + c > p &&
                    ((this.itemX = d),
                    (this.itemY += l + this.lastLineHeight + e),
                ...
                b
                    ? (this.itemX += c)
                    : ((this.itemY += l + h + e), (this.lastLineHeight = h));
                this.offsetWidth =
                    f ||
                    Math.max(
                        (b ? this.itemX - d - (a.checkbox ? 0 : k) : c) + d,
                        this.offsetWidth
                    );
            },
            getAllItems: function() {
                ...
                f(this.chart.series, function(c) {
                    var d = c && c.options;
                    c &&
                        w(d.showInLegend, n(d.linkedTo) ? !1 : void 0, !0) &&
                        (a = a.concat(
                            c.legendItems ||
                                ("point" === d.legendType ? c.data : c)
                        ));
                });
                            ...
                            e.test(h) &&
                                ...
                                (d[x[l]] = Math.max(
                                    ...
                                    d.legend[
                                        ...
                                        c[l] +
                                        (0 === l &&
                                        void 0 !== d.options.title.margin
                                            ? d.titleOffset +
                                              d.options.title.margin
                                            : 0)
                                ));
                        }
                    );
                ...
                f(
                    ...
                    function(b) {
                        ...
                        b.xAxis &&
                            ...
                            (e = a.find(
                                e ? b.points : b.points.slice(0).reverse(),
                                function(b) {
                            ...
                            h.push({
                                target: b.visible
                                    ? (e ? e.plotY : b.xAxis.height) - 0.3 * k
                                    : c.plotHeight,
                                size: k,
                                item: b
                            }));
            ...
            render: function() {
                ...
                d ||
                    ...
                    (this.contentGroup = h
                        ...
                        .attr({ zIndex: 1 })
                        .add(d)),
                    (this.scrollGroup = h.g().add(this.contentGroup)));
                this.renderTitle();
                b = this.getAllItems();
                c(b, function(a, b) {
                    return (
            ...
            handleOverflow: function(a) {
                ...
                "horizontal" !== h.layout ||
                    "middle" === h.verticalAlign ||
                    h.floating ||
                    (d /= 2);
                e && (d = Math.min(d, e));
                t.length = 0;
                a > d && !1 !== n.enabled
                    ? ((this.clipHeight = k = Math.max(
                          d - 20 - this.titleHeight - l,
                          0
                      )),
                      ...
                      p ||
                          ((p = c.clipRect = b.clipRect(0, l, 9999, 0)),
                          c.contentGroup.clip(p)),
                      r(k),
                      A ||
                          ((this.nav = A = b
                              .g()
            ...
            scroll: function(a, c) {
                ...
                0 < a &&
                    ...
                    (this.scrollOffset = -d[a - 1] + this.initialItemY),
        ...
        a.LegendSymbolMixin = {
            ...
            drawLineMarker: function(a) {
                ...
                d &&
                    !1 !== d.enabled &&
                    b &&
                    ((c = Math.min(w(d.radius, e), e)),
                    0 === this.symbol.indexOf("url") &&
                        ((d = t(d, { width: h, height: h })), (c = 0)),
                    (this.legendSymbol = d = l
        ...
        (/Trident\/7\.0/.test(h.navigator.userAgent) || u) &&
            p(a.Legend.prototype, "positionItem", function(a, c) {
                var d = this,
                    b = function() {
        ...
        p(O.prototype, {
            ...
            init: function(b, c) {
                ...
                q(this, "init", { args: arguments }, function() {
                    b.series = null;
                    d = B(x, b);
                    for (g in d.plotOptions)
                        d.plotOptions[g].tooltip =
                            (h[g] && B(h[g].tooltip)) || void 0;
            ...
            initSeries: function(b) {
                ...
                (c = E[b.type || c.type || c.defaultSeriesType]) ||
                    a.error(17, !0);
                c = new c();
                c.init(this, b);
                return c;
            ...
            redraw: function(b) {
                ...
                for (b = d.length; b--; )
                    if (
                        ((G = d[b]),
                        G.options.stacking && ((f = !0), G.isDirty))
                    ) {
                        A = !0;
                        break;
                    }
                if (A)
                    for (b = d.length; b--; )
                        (G = d[b]), G.options.stacking && (G.isDirty = !0);
                h(d, function(a) {
                    a.isDirty &&
                        ("point" === a.options.legendType
                            ? (a.updateTotals && a.updateTotals(), (l = !0))
                            : e &&
                    ...
                    function(a) {
                        ...
                        c &&
                            ...
                            c
                                .css({
                                    width:
                                        (m.width || g.width + m.widthAdjust) +
                                        "px"
                                })
                                .align(p({ y: a + h }, m), !1, "spacingBox"),
                            m.floating ||
                                m.verticalAlign ||
                                (b = Math.ceil(
                                    b + c.getBBox(m.useHTML).height
                                )));
                    },
                    this
                );
            ...
            temporaryDisplay: function(b) {
                ...
                if (b)
                    for (; c && c.style; )
                        c.hcOrigStyle &&
                            (a.css(c, c.hcOrigStyle), delete c.hcOrigStyle),
                            c.hcOrigDetached &&
            ...
            getContainer: function() {
                ...
                this.container = c = u("div", { id: e }, l, c);
                ...
                this.renderer = new (a[g.renderer] || a.Renderer)(
                    ...
                    null,
                    g.forExport,
                    d.exporting && d.exporting.allowHTML
                );
            ...
            reflow: function(b) {
                ...
                if (!h && !d.isPrinting && e && g && (m === M || m === f)) {
                    if (e !== d.containerWidth || g !== d.containerHeight)
                        a.clearTimeout(d.reflowTimeout),
                            (d.reflowTimeout = r(
                                function() {
                                    d.container &&
                                        d.setSize(void 0, void 0, !1);
                                },
                                b ? 100 : 0
                            ));
                    d.containerWidth = e;
            ...
            setReflow: function(a) {
                ...
                !1 === a || this.unbindReflow
                    ...
                    : ((this.unbindReflow = C(M, "resize", function(a) {
                          b.reflow(a);
                      })),
            ...
            setChartSize: function(a) {
                ...
                this.plotWidth = k = Math.max(
                    0,
                    Math.round(g - f - this.marginRight)
                );
                this.plotHeight = r = Math.max(
                    0,
                    Math.round(d - A - this.marginBottom)
                );
                ...
                this.plotBox = c.plotBox = { x: f, y: A, width: k, height: r };
                ...
                this.clipBox = {
                    ...
                    y: c,
                    width: Math.floor(
                        this.plotSizeX - Math.max(g, l[1]) / 2 - b
                    ),
                    height: Math.max(
                        0,
                        Math.floor(this.plotSizeY - Math.max(g, l[2]) / 2 - c)
                    )
                };
                a ||
            ...
            drawChartBox: function() {
                ...
                f = { fill: f || "none" };
                if (e || d["stroke-width"])
                    (f.stroke = a.borderColor), (f["stroke-width"] = e);
                ...
                m ||
                    ((u = "attr"),
                    (this.plotBackground = m = b
                        .rect()
                        .addClass("highcharts-plot-background")
                        .add()));
                m[u](n);
                m.attr({ fill: A || "none" }).shadow(a.plotShadow);
                k &&
                    (l
                        ? l.animate(n)
                        : (this.plotBGImage = b.image(k, p, G, v, E).add()));
                B
                    ? B.animate({ width: t.width, height: t.height })
            ...
            propFromSeries: function() {
                ...
                h(["inverted", "angular", "polar"], function(h) {
                    ...
                    for (d = g && g.length; !m && d--; )
                        (c = E[g[d].type]) && c.prototype[h] && (m = !0);
                    a[h] = m;
                });
            },
            linkSeries: function() {
    ...
    (function(a) {
        ...
        C(F, "afterSetChartSize", function(n) {
            ...
            (f = f && f.minWidth) &&
                ...
                (this.scrollablePixels = f = Math.max(
                    0,
                    f - this.chartWidth
                )) &&
                ((this.plotWidth += f),
        ...
        F.prototype.applyFixed = function() {
            ...
            u &&
                ...
                (this.fixedRenderer = f = new a.Renderer(this.fixedDiv, 0, 0)),
    ...
    (function(a) {
        ...
        a.Point.prototype = {
            ...
            applyOptions: function(a, c) {
                ...
                void 0 === this.x &&
                    e &&
                    (this.x = void 0 === c ? e.autoIncrement(this) : c);
                return this;
            },
            ...
            optionsToObject: function(c) {
                ...
                if (x(c) || null === c) e[d[0]] = c;
                    ...
                    for (
                        ...
                        (f && void 0 === c[v]) ||
                            (0 < d[n].indexOf(".")
                                ? a.Point.prototype.setNestedProperty(
                                      e,
                                      c[v],
                                      d[n]
                                  )
                    ...
                    "object" === typeof c &&
                        ((e = c),
                        c.dataLabels && (h._hasPointLabels = !0),
                        c.marker && (h._hasPointMarkers = !0));
                return e;
            },
            ...
            firePointEvent: function(a, c, e) {
                ...
                (d.point.events[a] ||
                    (h.options && h.options.events && h.options.events[a])) &&
                    this.importEvents();
                "click" === a &&
                    d.allowPointSelect &&
                    (e = function(a) {
            ...
            },
            {
                ...
                autoIncrement: function() {
                    ...
                    d &&
                        ...
                        "day" === d
                            ...
                            : "year" === d &&
                              e.set("FullYear", a, e.get("FullYear", a) + c),
                        (c = a.getTime() - b));
                    this.xIncrement = b + c;
                    return b;
                },
                setOptions: function(a) {
                    ...
                    this.tooltipOptions = d(
                        ...
                        m.tooltip.userOptions,
                        h.series && h.series.tooltip,
                        h[this.type].tooltip,
                        a.tooltip
                    );
                    ...
                    c(this, "afterSetOptions", { options: b });
                    return b;
                },
                getName: function() {
                ...
                getCyclic: function(a, b, c) {
                    var d,
                        ...
                        f = c
                            ? c.length
                            : v(e.options.chart[a + "Count"], e[a + "Count"]);
                    b ||
                        ((d = v(g[m], g["_" + m])),
                        x(d) ||
                            (e.series.length || (e[h] = 0),
                            (g["_" + m] = d = e[h] % f),
                            (e[h] += 1)),
                        c && (b = c[d]));
                    void 0 !== d && (this[m] = d);
                ...
                getColor: function() {
                    this.options.colorByPoint
                        ...
                        : this.getCyclic(
                              "color",
                              this.options.color || u[this.type].color,
                ...
                updateData: function(b) {
                    ...
                    t(
                        ...
                        function(b) {
                            ...
                            k(g) &&
                                ((g = a.inArray(g, this.xData, h)),
                                -1 === g || d[g].touched
                                    ? e.push(b)
                                    : b !== c.data[g]
                                    ? (d[g].update(b, !1, null, !1),
                                      (d[g].touched = !0),
                                      f && (h = g + 1))
                                    : d[g] && (d[g].touched = !0),
                                (m = !0));
                    ...
                    q &&
                        ...
                        (c[e - 1] < B || c[0] > t
                            ...
                            : this.yData &&
                              ...
                              (g = !0)));
                    for (l = c.length || 1; --l; )
                        (e = v ? k(c[l]) - k(c[l - 1]) : c[l] - c[l - 1]),
                            0 < e && (void 0 === h || e < h)
                                ? (h = e)
                                : 0 > e && n && (a.error(15), (n = !1));
                    this.cropped = g;
                    this.cropStart = m;
                ...
                generatePoints: function() {
                    ...
                    c ||
                        q ||
                        ((c = []), (c.length = b.length), (c = this.data = c));
                        ...
                        (p = k + B),
                            q
                                ? ((v = new h().init(
                                  ...
                                  (v.dataGroup = this.groupMap[B]),
                                  v.dataGroup.options &&
                                      ((v.options = v.dataGroup.options),
                                      y(v, v.dataGroup.options)))
                                : (v = c[p]) ||
                                  void 0 === b[p] ||
                                  (c[p] = v = new h().init(this, b[p], e[B])),
                            v && ((v.index = p), (n[B] = v));
                    this.options.keys = a;
                    if (c && (f !== (d = c.length) || q))
                        for (B = 0; B < d; B++)
                ...
                getExtremes: function(a) {
                    ...
                    for (B = 0; B < d; B++)
                        if (
                            ...
                            (f =
                                (k(v, !0) || p(v)) &&
                                (!b.positiveValuesOnly || v.length || 0 < v)),
                            (l =
                ...
                translate: function() {
                    ...
                    for (a = 0; a < l; a++) {
                        ...
                        b &&
                            ...
                            I &&
                            I[C] &&
                            ((w = this.getStackIndicator(w, C, this.index)),
                            (K = I[C]),
                            (F = K.points[w.key]),
                            (D = F[0]),
                            (F = F[1]),
                            D === t &&
                                w.key === I[C].base &&
                                (D = v(k(n) && n, h.min)),
                            h.positiveValuesOnly && 0 >= D && (D = null),
                        ...
                        L.yBottom = x(D)
                            ? Math.min(
                                  Math.max(-1e5, h.translate(D, 0, 1, 0, 1)),
                                  1e5
                              )
                            : null;
                        p && (F = this.modifyValue(F, L));
                        L.plotY = D =
                            "number" === typeof F && Infinity !== F
                                ? Math.min(
                                      Math.max(
                                          -1e5,
                                          h.translate(F, 0, 1, 0, 1)
                                      ),
                                      1e5
                                  )
                                : void 0;
                        ...
                        L.isNull ||
                            (void 0 !== y && (J = Math.min(J, Math.abs(u - y))),
                            (y = u));
                ...
                animate: function(a) {
                    ...
                    a
                        ...
                        : ((d = this.sharedClipKey),
                          (a = b[d]) &&
                              a.animate({ width: b.plotSizeX, x: 0 }, c),
                          b[d + "m"] &&
                              b[d + "m"].animate(
                                  { width: b.plotSizeX + 99, x: 0 },
                                  c
                              ),
                          (this.animate = null));
                },
                    ...
                    if (!1 !== h.enabled || this._hasPointMarkers)
                        for (c = 0; c < a.length; c++)
                            (d = a[c]),
                                ...
                                (f = d.marker || {}),
                                (l = !!d.marker),
                                (e = (n && void 0 === f.enabled) || f.enabled),
                                (k = d.isInside),
                                e && !d.isNull
                                    ? ((e = v(f.symbol, this.symbol)),
                                      (q = this.markerAttribs(
                                          d,
                                          d.selected && "select"
                                      )),
                                      g
                                          ? g[k ? "show" : "hide"](!0).animate(
                                                q
                                            )
                                          : k &&
                                            (0 < q.width || d.hasImage) &&
                                            (d.graphic = g = b.renderer
                                                .symbol(
                                                    e,
                                                    q.x,
                                                    q.y,
                ...
                pointAttribs: function(a, b) {
                    ...
                    b &&
                        ...
                        (d = v(
                            b.lineWidth,
                            c.lineWidth,
                            d + v(b.lineWidthPlus, c.lineWidthPlus, 0)
                        )),
                        (a = b.fillColor || c.fillColor || a),
                        (g = b.lineColor || c.lineColor || g));
                    return { stroke: g, "stroke-width": d, fill: a };
                },
                destroy: function() {
                    var d = this,
                        e = d.chart,
                    ...
                    t(d.axisTypes || [], function(a) {
                        (p = d[a]) &&
                            p.series &&
                            (w(p.series, d), (p.isDirty = p.forceRedraw = !0));
                    });
                    ...
                    t(d, function(d, g) {
                        ...
                        h
                            ...
                            : c.length &&
                              ...
                              (h = a[e].attr(h).shadow(2 > g && b.shadow)));
                    ...
                    d.length &&
                        ...
                        t(d, function(d, m) {
                            ...
                            h[m]
                                ? h[m].animate(f)
                                : ((h[m] = c.clipRect(f)),
                                  l && a["zone-graph-" + m].clip(h[m]),
                                  k && a["zone-area-" + m].clip(h[m]));
                            J = d.value > n.max;
    ...
    (function(a) {
        ...
        a.StackItem = function(a, c, e, f, k) {
            ...
            this.alignOptions = {
                ...
                verticalAlign:
                    c.verticalAlign || (h ? "middle" : e ? "bottom" : "top"),
                y: t(c.y, h ? 4 : e ? 14 : -6),
                x: t(c.x, h ? (e ? -6 : 6) : 0)
            };
            this.textAlign =
                c.textAlign || (h ? (e ? "right" : "left") : "center");
        };
        a.StackItem.prototype = {
            ...
            setOffset: function(a, c) {
                var e = this.axis,
                    f = e.chart,
                    k = e.translate(
                        e.usePercentage ? 100 : this.total,
                        0,
                        0,
                        0,
                        1
                ...
                (c = this.label) &&
                    ...
                    (e = c.alignAttr),
                    c[
                        !1 === this.options.crop || f.isInsidePlot(e.x, e.y)
                            ? "show"
                            : "hide"
                    ](!0));
            },
        ...
        F.prototype.getStacks = function() {
            ...
            e(a.series, function(c) {
                !c.options.stacking ||
                    ...
                    (c.stackKey = c.type + t(c.options.stack, ""));
            });
        };
        ...
        w.prototype.setStackedPoints = function() {
            if (
                ...
                for (E = 0; E < f; E++)
                    (g = e[E]),
                        (r = c[E]),
                        (m = this.getStackIndicator(m, g, this.index)),
                        (x = m.key),
                        (A = (G = l && r < (d ? 0 : q)) ? u : v),
                        B[A] || (B[A] = {}),
                        B[A][g] ||
                            (D[A] && D[A][g]
                                ? ((B[A][g] = D[A][g]), (B[A][g].total = null))
                                : (B[A][g] = new a.StackItem(
                                      w,
                        ...
                        (A = B[A][g]),
                        null !== r
                            ? ((A.points[x] = A.points[this.index] = [
                                  t(A.cumulative, d)
                              ]),
                              n(A.cumulative) || (A.base = x),
                              (A.touched = w.stacksTouched),
                              0 < m.index &&
                                  !1 === this.singleStacks &&
                                  (A.points[x][0] =
                                      A.points[this.index + "," + g + ",0"][0]))
                            : (A.points[x] = A.points[this.index] = null),
                        "percent" === k
                            ? ((G = G ? v : u),
                              l && B[G] && B[G][g]
                                  ? ((G = B[G][g]),
                                    (A.total = G.total =
                                        Math.max(G.total, A.total) +
                                            Math.abs(r) || 0))
                                  : (A.total = I(A.total + (Math.abs(r) || 0))))
                            : (A.total = I(A.total + (r || 0))),
                        (A.cumulative = t(A.cumulative, d) + (r || 0)),
                        null !== r &&
                            (A.points[x].push(A.cumulative),
                            (h[E] = A.cumulative));
            ...
            a[q + "Stacker"] &&
                e([c, "-" + c], function(c) {
                    for (var b = f.length, d, e; b--; )
                        if (
                            ((d = f[b]),
                            (k = a.getStackIndicator(k, d, a.index, c)),
                            (e = (d = h[c] && h[c][d]) && d.points[k.key]))
                        )
                            a[q + "Stacker"](e, d, b);
                });
        };
    ...
    (function(a) {
        ...
        t(a.Chart.prototype, {
            addSeries: function(a, b, c) {
                ...
                a &&
                    ((b = d(b, !0)),
                    w(h, "addSeries", { options: a }, function() {
                        e = h.initSeries(a);
                        h.isDirtyLegend = !0;
                        h.linkSeries();
                        w(h, "afterAddSeries");
            ...
            addAxis: function(a, b, c, e) {
                var h = b ? "xAxis" : "yAxis",
                    f = this.options;
                a = k(a, { index: this[h].length, isX: b });
                b = new I(this, a);
                f[h] = L(f[h] || {});
                f[h].push(a);
                d(c, !0) && this.redraw(e);
            ...
            showLoading: function(a) {
                ...
                f(d, t(e.style, { zIndex: 10 }));
                f(b.loadingSpan, e.labelStyle);
                b.loadingShown ||
                    (f(d, { opacity: 0, display: "" }),
                    F(
                        d,
            ...
            update: function(a, b, h, f) {
                ...
                if (p) {
                    ...
                    "alignTicks" in p && (g = !0);
                    q(p, function(a, b) {
                        -1 !== y("chart." + b, l.propsRequireUpdateSeries) &&
                            (r = !0);
                        -1 !== y(b, l.propsRequireDirtyBox) &&
                            (l.isDirtyBox = !0);
                    });
                ...
                q(a, function(a, b) {
                    if (l[b] && "function" === typeof l[b].update)
                        l[b].update(a, !1);
                    else if ("function" === typeof l[m[b]]) l[m[b]](a);
                    "chart" !== b &&
                        -1 !== y(b, l.propsRequireUpdateSeries) &&
                        (r = !0);
                });
                u(
                        ...
                        a[b] &&
                            ...
                            u(L(a[b]), function(a, d) {
                                (d =
                                    ...
                                    l[b][c ? c[d] : d]) &&
                                    d.coll === b &&
                                    (d.update(a, !1), h && (d.touched = !0));
                                if (!d && h)
                                    if ("series" === b)
                                        l.addSeries(a, !1).touched = !0;
                ...
                r &&
                    u(l.series, function(a) {
                        a.update({}, !1);
                    });
                a.loading && k(!0, l.options.loading, a.loading);
                g = p && p.width;
                p = p && p.height;
                (c(g) && g !== l.chartWidth) || (c(p) && p !== l.chartHeight)
                    ? l.setSize(g, p, f)
                    : d(b, !0) && l.redraw(f);
                w(l, "afterUpdate", { options: a });
            },
        ...
        t(b.prototype, {
            update: function(a, b, c, e) {
                ...
                var l = this,
                    ...
                    p = m.options;
                b = d(b, !0);
                !1 === e ? f() : l.firePointEvent("update", { options: a }, f);
            },
            remove: function(a, b) {
        ...
        t(v.prototype, {
            ...
            update: function(b, c) {
                var e = this,
                    ...
                    B = e.finishedAnimating && { animation: !1 },
                ...
                getStackPoints: function(e) {
                    ...
                    if (this.options.stacking) {
                        for (v = 0; v < e.length; v++)
                            (e[v].leftNull = e[v].rightNull = null),
                                (h[e[v].x] = e[v]);
            ...
            {},
            {
                getPointSpline: function(a, I, n) {
                    ...
                    if (
                        ...
                        y += c;
                        t > a && t > e
                            ? ((t = Math.max(a, e)), (y = 2 * e - t))
                            : t < a &&
                              t < e &&
                              ((t = Math.min(a, e)), (y = 2 * e - t));
                        y > n && y > e
                            ? ((y = Math.max(n, e)), (t = 2 * e - y))
                            : y < n &&
                              y < e &&
                    ...
                    I = [
                        "C",
                        C(u.rightContX, u.plotX),
                        C(u.rightContY, u.plotY),
                        C(x, f),
                        C(t, e),
                        f,
                        e
        ...
        w(
            ...
            },
            {
                ...
                getColumnMetrics: function() {
                    ...
                    var n = Math.min(
                        ...
                        e = Math.min(
                            ...
                            x(e.pointWidth, t * (1 - 2 * e.pointPadding))
                        );
                    a.columnMetrics = {
                        width: e,
                        offset:
                ...
                crispCol: function(a, e, f, k) {
                    ...
                    k -= e;
                    b && k && (--e, (k += 1));
                    return { x: a, y: e, width: f, height: k };
                },
                translate: function() {
                    var a = this,
                        e = a.chart,
                    ...
                    I(a.points, function(c) {
                        ...
                        v &&
                            ...
                            c.y === d &&
                                ...
                                (r = !r),
                            (g =
                                Math.abs(g - b) > v ? h - v : b - (r ? v : 0)));
                        f(c.options.pointWidth) &&
                            ((p = t = Math.ceil(c.options.pointWidth)),
                            (n -= Math.round((p - l) / 2)));
                        c.barX = n;
                        c.pointWidth = p;
                        c.tooltipPos = e.inverted
                            ? [
                                  q.len + q.pos - e.plotLeft - k,
                                  a.xAxis.len - n - t / 2,
                                  w
                              ]
                            : [n + t / 2, k + q.pos - e.plotTop, w];
                        c.shapeType = "rect";
                        c.shapeArgs = a.crispCol.apply(
                            a,
                            c.isNull ? [n, b, t, 0] : [n, g, t, w]
                        );
                    });
                },
                getSymbol: a.noop,
                ...
                pointAttribs: function(a, e) {
                    ...
                    e &&
                        ...
                        (b =
                            ...
                            (void 0 !== e &&
                                F(b)
                                    .brighten(a.brightness)
                                    .get()) ||
                            b),
                        (n = a[f] || n),
                        (t = a[d] || t),
                        (h = a.dashStyle || h));
                    f = { fill: b, stroke: n, "stroke-width": t };
                    h && (f.dashstyle = h);
                    return f;
                },
                drawPoints: function() {
                    ...
                    I(a.points, function(b) {
                        ...
                        if (e(b.plotY) && null !== b.y) {
                            ...
                            if (c) c[h](u(d));
                                ...
                                b.graphic = c = k[b.shapeType](d).add(
                                    b.group || a.group
                                );
                            p.borderRadius && c.attr({ r: p.borderRadius });
                            c[h](
                                a.pointAttribs(b, b.selected && "select")
                            ).shadow(
                                p.shadow,
                                null,
                    ...
                    y &&
                        (a
                            ? ((d.scaleY = 0.001),
                              (a = Math.min(
                                  e.pos + e.len,
                                  Math.max(e.pos, e.toPixels(f.threshold))
                              )),
                              q
                                  ? (d.translateX = a - e.len)
                                  : (d.translateY = a),
                              c.group.attr(d))
                            : ((v = c.group.attr(b)),
                              c.group.animate(
        ...
        c(
            ...
            },
            {
                ...
                translate: function(a) {
                    ...
                    for (A = 0; A < y; A++) {
                        ...
                        n = (Math.cos(l) * a[2]) / 2;
                        m = (Math.sin(l) * a[2]) / 2;
                        E.tooltipPos = [a[0] + 0.7 * n, a[1] + 0.7 * m];
                        E.half = l < -Math.PI / 2 || l > Math.PI / 2 ? 1 : 0;
                        E.angle = l;
                        h = Math.min(b, E.labelDistance / 5);
                        E.labelPos = [
                            a[0] + n + Math.cos(l) * E.labelDistance,
                            a[1] + m + Math.sin(l) * E.labelDistance,
                            a[0] + n + Math.cos(l) * h,
                            a[1] + m + Math.sin(l) * h,
                            a[0] + n,
                            a[1] + m,
                ...
                drawPoints: function() {
                    ...
                    t &&
                        !a.shadowGroup &&
                        (a.shadowGroup = c.g("shadow").add(a.group));
            ...
            },
            {
                ...
                setVisible: function(a, c) {
                    ...
                    c = t(c, f);
                    a !== e.visible &&
                        ((e.visible = e.options.visible = a =
                            void 0 === a ? !e.visible : a),
                        (d.options.data[u(e, d.data)] = e.options),
                        n(
                            [
                                "graphic",
                                "dataLabel",
                        ...
                        e.legendItem && b.legend.colorizeItem(e, a),
    ...
    (function(a) {
        ...
        a.distribute = function(b, c, d) {
                ...
                for (f = b.length; f--; )
                    (h = b[f]),
                        (v =
                            ...
                            2),
                        (h.pos = Math.min(
                            Math.max(0, v - h.size * h.align),
                            c - h.size
                        ));
                f = b.length;
                for (h = !1; f--; )
                    0 < f &&
                        b[f - 1].pos + b[f - 1].size > b[f].pos &&
                        ((b[f - 1].size += b[f].size),
                        (b[f - 1].targets = b[f - 1].targets.concat(
                            b[f].targets
                        )),
                        (b[f - 1].align = 0.5),
                        b[f - 1].pos + b[f - 1].size > c &&
                            (b[f - 1].pos = c - b[f - 1].size),
                        b.splice(f, 1),
                        (h = !0));
            }
            q.push.apply(q, m);
            ...
            p(b, function(b) {
                var e = 0;
                if (
                    p(b.targets, function() {
                        q[f].pos = b.pos + e;
                        if (Math.abs(q[f].pos - q[f].target) > d)
                            return (
                                n(q.slice(0, f + 1), function(a) {
                                    delete a.pos;
                                }),
                                (q.reducedLen = (q.reducedLen || c) - 0.1 * c),
                                q.reducedLen > 0.1 * c && a.distribute(q, c, d),
                                !0
                            );
                        e += q[f].size;
                        f++;
            ...
            var f = this,
                ...
                p = c(
                    c(
                        ...
                        h.options.plotOptions &&
                            h.options.plotOptions[f.type] &&
                            h.options.plotOptions[f.type].dataLabels
                    ),
                    p
                );
            if (q(p) || p.enabled || f._hasPointLabels)
                (A = f.plotGroup(
                    "dataLabelsGroup",
                    "data-labels",
                    F && !y ? "hidden" : "visible",
                    ...
                    n(t, function(g) {
                        m = d(
                            c(
                                p,
                                g.dlOptions ||
                                    (g.options && g.options.dataLabels)
                            )
                        );
                        n(m, function(c, d) {
                            ...
                            l &&
                                ((m = g.getLabelConfig()),
                                (n = c[g.formatPrefix + "Format"] || c.format),
                                (m = I(n)
                                    ? e(n, m, h.time)
                                    : (
                                          c[g.formatPrefix + "Formatter"] ||
                                          c.formatter
                                      ).call(m, c)),
                                (n = c.style),
                                (q = c.rotation),
                                ...
                                "contrast" === n.color &&
                                    ((g.contrastColor = E.getContrast(
                                        g.color || f.color
                                    )),
                                    (n.color =
                                        c.inside ||
                                        0 > w(c.distance, g.labelDistance) ||
                                        k.stacking
                                            ? g.contrastColor
                                            : "#000000")),
                            ...
                            !p || (l && I(m))
                                ? l &&
                                  ...
                                  (p.options = c),
                                  p.attr(r),
                                  p.css(n).shadow(c.shadow),
                                  p.added || p.add(A),
                                  f.alignDataLabel(g, p, c, null, t))
                                : ((g.dataLabel = g.dataLabel.destroy()),
                                  g.dataLabels &&
                                      (1 === g.dataLabels.length
                                          ? delete g.dataLabels
                                          : delete g.dataLabels[d]),
                                  d || delete g.dataLabel,
                                  v &&
                                      ((g.connector = g.connector.destroy()),
                                      g.connectors &&
                                          (1 === g.connectors.length
                                              ? delete g.connectors
                                              : delete g.connectors[d])));
                        });
                    });
        ...
        c.prototype.alignDataLabel = function(a, c, d, e, h) {
            var b = this.chart,
                ...
                r =
                    this.visible &&
                    (a.series.forceDL ||
                        b.isInsidePlot(m, Math.round(k), l) ||
                        (e &&
                            b.isInsidePlot(
                                m,
                                l ? e.x + 1 : e.y + e.height - 1,
                                l
                            ))),
            ...
            if (
                r &&
                ((q = d.style.fontSize),
                (q = b.renderer.fontMetrics(q, c).b),
                (e = f(
                    {
                ...
                f(d, { width: n.width, height: n.height }),
                p
                    ? ((v = !1),
                      (m = b.renderer.rotCorr(q, p)),
                      (m = {
                      ...
                      c[h ? "attr" : "animate"](m).attr({ align: g }),
                      (k = (p + 720) % 360),
                      (k = 180 < k && 360 > k),
                      "left" === g
                          ? (m.y -= k ? n.height : 0)
                          : "center" === g
                          ? ((m.x -= n.width / 2), (m.y -= n.height / 2))
                          : "right" === g &&
                            ((m.x -= n.width), (m.y -= k ? 0 : n.height)),
                      (c.placed = !0),
                      (c.alignAttr = m))
                    : (c.align(d, null, e), (m = c.alignAttr)),
                v && 0 <= e.height
                    ...
                    : w(d.crop, !0) &&
                      (r =
                          b.isInsidePlot(m.x, m.y) &&
                          b.isInsidePlot(m.x + n.width, m.y + n.height)),
                d.shape && !p)
            )
                c[h ? "attr" : "animate"]({
        ...
        c.prototype.justifyDataLabel = function(a, c, d, e, f, h) {
            ...
            n = d.x + p;
            0 > n &&
                ("right" === l ? (c.align = "left") : (c.x = -n), (q = !0));
            n = d.x + e.width - p;
            n > b.plotWidth &&
                ("left" === l ? (c.align = "right") : (c.x = b.plotWidth - n),
                (q = !0));
            n = d.y + p;
            0 > n &&
                ("bottom" === k ? (c.verticalAlign = "top") : (c.y = -n),
                (q = !0));
            n = d.y + e.height - p;
            n > b.plotHeight &&
                ("top" === k
        ...
        h.pie &&
            ((h.pie.prototype.drawDataLabels = function() {
                ...
                b.visible &&
                    ...
                    n(Q, function(c, d) {
                        ...
                        if (t)
                            for (
                                b.sortByAngle(c, d - 0.5),
                                    0 < b.maxLabelDistance &&
                                        ((l = Math.max(
                                            0,
                                            r - g - b.maxLabelDistance
                                        )),
                                        (q = Math.min(
                                            r + g + b.maxLabelDistance,
                                            f.plotHeight
                                ...
                                (e = c[S]),
                                    ...
                                    (z = h.justify
                                        ? x[0] +
                                          (d ? -1 : 1) * (g + e.labelDistance)
                                        : b.getX(
                                              P < e.top + 2 || P > e.bottom - 2
                                                  ? l
                                                  : P,
                                              d,
                                              e
                                          )),
                                    (y._attr = { visibility: T, align: H[6] }),
                                    (y._pos = {
                                        x:
                                            z +
                                            h.x +
                                            ({ left: k, right: -k }[H[6]] || 0),
                                        y: P + h.y - 10
                                    }),
                                    (H.x = z),
                                    (H.y = P),
                    ...
                    0 === F(U) || this.verifyDataLabelOverflow(U)) &&
            ...
            (h.pie.prototype.connectorPath = function(a) {
                var b = a.x,
                    c = a.y;
                return w(this.options.dataLabels.softConnector, !0)
                    ? [
                          "M",
                          b + ("left" === a[6] ? 5 : -5),
                          c,
            ...
            (h.pie.prototype.verifyDataLabelOverflow = function(a) {
                ...
                h ||
                    (null !== d[0]
                        ? (f = Math.max(b[2] - Math.max(a[1], a[3]), e))
                        : ((f = Math.max(b[2] - a[1] - a[3], e)),
                          (b[0] += (a[3] - a[1]) / 2)),
                    null !== d[1]
                        ? (f = Math.max(
                              Math.min(f, b[2] - Math.max(a[0], a[2])),
                              e
                          ))
                        : ((f = Math.max(Math.min(f, b[2] - a[0] - a[2]), e)),
                          (b[1] += (a[0] - a[2]) / 2)),
                    f < b[2]
                        ? ((b[2] = f),
                          (b[3] = Math.min(y(c.innerSize || 0, f), f)),
                          this.translate(b),
        ...
        h.column &&
            (h.column.prototype.alignDataLabel = function(a, d, e, f, h) {
                var b = this.chart.inverted,
                    l = a.series,
                    m = a.dlBox || a.shapeArgs,
                    k = w(
                        a.below,
                        a.plotY > w(this.translatedThreshold, l.yAxis.len)
                    ),
                    n = w(e.inside, !!this.options.stacking);
                m &&
                    ((f = x(m)),
                    0 > f.y && ((f.height += f.y), (f.y = 0)),
                    (m = f.y + f.height - l.yAxis.len),
                    0 < m && (f.height -= m),
                    b &&
                        (f = {
                    ...
                    n ||
                        (b
                            ? ((f.x += k ? 0 : f.width), (f.width = 0))
                            : ((f.y += k ? f.height : 0), (f.height = 0))));
                e.align = w(e.align, !b || n ? "center" : k ? "right" : "left");
                e.verticalAlign = w(
                    e.verticalAlign,
                    b || n ? "middle" : k ? "top" : "bottom"
                );
                ...
                if (a && (!a.alignAttr || a.placed))
                    return (
                        ...
                        a.width ||
                            ...
                            (a.width = e.width),
                            (a.height = e.height),
                            (e = f.fontMetrics(null, a.element).h)),
                        {
    ...
    (function(a) {
        ...
        J = a.TrackerMixin = {
                ...
                a._hasTracking ||
                    (u(a.trackerGroups, function(d) {
                        if (a[d]) {
                            ...
                            a.options.cursor &&
                                a[d].css(n).css({ cursor: a.options.cursor });
                        }
                    }),
                    (a._hasTracking = !0));
            ...
            drawTrackerGraph: function() {
                var a = this,
                    ...
                    x = "rgba(192,192,192," + (v ? 0.0001 : 0.002) + ")";
                if (e && !c)
                    for (q = e + 1; q--; )
                        "M" === d[q] &&
                            d.splice(q + 1, 0, d[q + 1] - n, d[q + 2], "L"),
                            ((q && "M" === d[q]) || q === e) &&
        ...
        x(F.prototype, {
            ...
            zoomOut: function() {
                t(this, "selection", { resetSelection: !0 }, this.zoom);
            },
            zoom: function(a) {
                var b,
                    d = this.pointer,
                ...
                !a || a.resetSelection
                    ...
                    : u(a.xAxis.concat(a.yAxis), function(a) {
                          ...
                          d[c.isXAxis ? "zoomX" : "zoomY"] &&
                              ((b = c.zoom(a.min, a.max)),
                              c.displayBtn && (e = !0));
                      });
                f = this.resetZoomButton;
                e && !f
                    ? this.showResetZoom()
                    : !e && c(f) && (this.resetZoomButton = f.destroy());
                b &&
                    this.redraw(
                        k(
            ...
            pan: function(a, b) {
                ...
                u("xy" === b ? [1, 0] : [1], function(b) {
                    ...
                    var d = b.horiz,
                        ...
                        l = Math.min(
                            ...
                            g
                                ? m.min
                                : b.toValue(
                                      b.toPixels(m.min) - b.minPixelPadding
                                  )
                        ),
                        g = Math.max(
                            m.dataMax,
                            g
                                ? m.max
                                : b.toValue(
                                      b.toPixels(m.max) + b.minPixelPadding
                                  )
                        ),
                        n = l - h;
                    0 < n && ((k += n), (h = l));
                    ...
                    b.series.length &&
                        h !== m.min &&
                        k !== m.max &&
                        (b.setExtremes(h, k, !1, !1, { trigger: "pan" }),
                        (e = !0));
                    c[d] = f;
                });
                e && c.redraw(!1);
            ...
            select: function(a, b) {
                ...
                c.firePointEvent(
                    ...
                    function() {
                        ...
                        c.setState(a && "select");
                        b ||
                            u(e.getSelectedPoints(), function(a) {
                                a.selected &&
                                    a !== c &&
                                    ((a.selected = a.options.selected = !1),
                                    (d.options.data[y(a, d.data)] = a.options),
                                    a.setState(""),
                ...
                if (
                    ...
                    if (this.graphic)
                        this.state &&
                            ...
                            this.graphic.animate(
                                f.pointAttribs(this, a),
                                k(u.options.chart.animation, h.animation)
                            ),
                            y &&
                                this.graphic.animate(
                                    y,
                        ...
                        if (a && q) {
                            ...
                            if (p)
                                p[b ? "animate" : "attr"]({ x: y.x, y: y.y });
                            else
                                l &&
                                    ((f.stateMarkerGraphic = p = u.renderer
                                        .symbol(l, y.x, y.y, y.width, y.height)
                                        .add(f.markerGroup)),
                                    (p.currentSymbol = l));
                        ...
                        p &&
                            (p[
                                a && u.isInsidePlot(c, d, u.inverted)
                                    ? "show"
                                    : "hide"
                            ](),
                    ...
                    (c = h.halo) && c.size
                        ? (w ||
                              (f.halo = w = u.renderer
                                  .path()
                                  .add((this.graphic || p).parentGroup)),
                          w
                              .show()
                              [b ? "animate" : "attr"]({
                          ...
                          w.attr({
                              class:
                                  ...
                                  k(this.colorIndex, f.colorIndex) +
        ...
        x(d.prototype, {
            ...
            setState: function(a) {
                ...
                if (
                    b.state !== a &&
                    (u([b.group, b.markerGroup, b.dataLabelsGroup], function(
                        c
                    ) {
                        c &&
                            (b.state &&
                    ...
                    (b.state = a),
                    !e[a] || !1 !== e[a].enabled) &&
                    (a && (f = e[a].lineWidth || f + (e[a].lineWidthPlus || 0)),
                    d && !d.dashstyle)
                )
                    for (
                        f = { "stroke-width": f },
            ...
            setVisible: function(a, b) {
                var c = this,
                    ...
                    k = c.visible;
                f = (c.visible = a = c.options.visible = c.userOptions.visible =
                    void 0 === a ? !k : a)
                    ? "show"
                    : "hide";
                u(
    ...
    (function(a) {
        ...
        C.prototype.matchResponsiveRule = function(a, f) {
            ...
            (
                ...
                function() {
                    return (
                        this.chartWidth <= e(n.maxWidth, Number.MAX_VALUE) &&
                        this.chartHeight <= e(n.maxHeight, Number.MAX_VALUE) &&
                        this.chartWidth >= e(n.minWidth, 0) &&
                        this.chartHeight >= e(n.minHeight, 0)
                    );
                }
            ...
            function t(e, c, h, p) {
                ...
                a.objectEach(e, function(a, d) {
                    if (!p && -1 < I(d, ["series", "xAxis", "yAxis"]))
                        for (a = u(a), h[d] = [], k = 0; k < a.length; k++)
                            c[d][k] &&
                                ((h[d][k] = {}),
                                t(a[k], c[d][k], h[d][k], p + 1));
                    else
                        f(a)
                            ? ((h[d] = n(a) ? [] : {}),
                              t(a, c[d] || {}, h[d], p + 1))
